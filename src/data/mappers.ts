...
const COSTS_FIELDS = ["tooling", "costMode", "cUnit", "costCurrency", "cMovement", "cCase", "cDial", "cHands", "cCrystal", "cStrap", "cAssembly", "cPack", "cShip", "cDuty", "cOther", "feePct"] as const satisfies readonly (keyof Project)[];
