...
describe("warrantyRegister", () => {
  const delivered = (over = {}) => ({ ...blankProject("a1"), currency: "EUR", costCurrency: "EUR", id: "p1", stage: "Delivered", ...over });
  ...
  it("only lists delivered pieces and flags status by expiry", () => {
    ...
    const open = { ...blankProject("a1"), currency: "EUR", costCurrency: "EUR", id: "p3", stage: "Production" };
...
describe("referralReport", () => {
  it("attributes referred clients, conversions and revenue", () => {
    ...
    const won = { ...blankProject("a1"), currency: "EUR", costCurrency: "EUR", id: "p1", stage: "Production", qty: "10", unitPrice: "100" };
